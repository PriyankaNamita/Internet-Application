    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Login(LoginViewModel model, string returnUrl)
        {
            ...
            try
            {
                ...
                var userRole = user.Roles.FirstOrDefault(u => u.UserId == user.Id);
                ...
                if (role.Name == "Customer")
                {
                    try
                    {
                        var isActive = _databaseContext.Customers.FirstOrDefault(c => c.Email == model.Email).IsActive;
                        if (!isActive)
                        {
                            ModelState.AddModelError("", "Your Account has been suspended by the admin");
                            return View(model);
                        }
                    }
                    catch
